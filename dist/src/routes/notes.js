...
router.post('/notes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, content, folder, userId, note, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, title = _a.title, content = _a.content, folder = _a.folder;
                userId = req.user.id;
                return [4 /*yield*/, prisma_1.default.note.create({
                        data: {
...
router.get('/notes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, folder, notes, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.note.findMany({
                        where: __assign({ userId: userId }, (folder ? { folder: String(folder) } : {})),
 ...
 */
router.put('/notes/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, title, content, folder, note, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, title = _a.title, content = _a.content, folder = _a.folder;
                return [4 /*yield*/, prisma_1.default.note.update({
                        where: { id: id },
                        data: { title: title, content: content, folder: folder },
                    })];
            case 1:
                note = _b.sent();
                res.json(note);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prisma_1.default.note.delete({ where: { id: id } })];
            case 1:
                _a.sent();
                res.status(204).send();
                return [3 /*break*/, 3];
