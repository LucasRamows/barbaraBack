...
var wppClient_1 = require("../whatsapp/wppClient");
...
router.get("/status", function (req, res) {
    try {
        var status = (0, wppClient_1.getWppStatus)();
        res.json(status);
    }
    catch (error) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, wppClient_1.client.logout()];
            case 1:
                _a.sent();
                return [4 /*yield*/, wppClient_1.client.destroy()];
            case 2:
                _a.sent();
                (0, wppClient_1.resetWppStatus)();
                return [4 /*yield*/, wppClient_1.client.initialize()];
            case 3:
                _a.sent();
            ...
            case 4:
                error_1 = _a.sent();
                console.error("Erro ao desconectar:", error_1);
